...
const styles = tv({
    extend: focusRing,
    base: 'flex items-center text-start gap-4 w-full font-sans border border-black/10 cursor-default rounded-lg pl-3 pr-2 h-9 min-w-[180px] transition bg-neutral-50 [-webkit-tap-highlight-color:transparent]',
    variants: {
        isDisabled: {
    ...
    return (
        <AriaSelect {...props} className={composeTailwindRenderProps(props.className, 'group flex flex-col gap-1 relative font-sans')}>
            ...
            <Button className={styles}>
                ...
                <ChevronDown aria-hidden className="w-4 h-4 text-neutral-600 forced-colors:text-[ButtonText] group-disabled:text-neutral-200 forced-colors:group-disabled:text-[GrayText]" />
            </Button>
