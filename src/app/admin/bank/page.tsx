        ...
        <AdminLayout activeTab="bank">
            ...
            <div className="bg-white rounded-xl shadow-md p-4 sm:p-6 mb-6 border border-slate-200">
                <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 sm:gap-6">
                    ...
                    {/* Фильтр: на мобилке элементы друг под другом, селект на всю ширину */}
                    <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4 w-full sm:w-auto">
                        ...
                        <select
                            ...
                            className="w-full sm:w-auto px-3 py-2 sm:px-4 sm:py-2 text-sm border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none bg-white"
                        >
                    ...
                    {/* Модалка/Кнопка создания: на мобилке растягивается на 100% */}
                    <div className="w-full sm:w-auto">
                        <UiModal
                            button={
                                <Button className="w-full sm:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-2.5 sm:py-2 rounded-lg font-medium transition-colors shadow-sm flex items-center justify-center gap-2">
                                    <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
                                    </svg>
                                    {/* На мобилках лучше добавить текст к кнопке, чтобы она не выглядела сиротливо на всю ширину */}
                                    <span className="sm:hidden text-sm">Создать задание</span>
                                </Button>
                            }
                        >
                            {({ close }) => (
