...
import {useCategory} from "@/features/category/model/useCategory";
...
export function Category () {
    const { item, handleControlClick, handleEducationClick, handleBack, isLoading, isError, isEmpty } = useCategory();

    return (
        <main className="container mx-auto px-6 py-12 max-w-5xl">

            { !isLoading && !isError && isEmpty && <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 flex items-center justify-center">
            ...
            {/* Description Card */}
            {!isLoading && !isError && item && <div>
                <UiTextArea children={item.detail_description}/>
                                ...
                                <div className="p-6 max-w-2xl">
                                    ...
                                    <div className="grid grid-cols-1 gap-3">
                                        {COMPLEXITY_LEVELS.map((level) => (
                                            <button
                                                key={level.id}
                                                onClick={() => handleEducationClick(level.id, close)}
